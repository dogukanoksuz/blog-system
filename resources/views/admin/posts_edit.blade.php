...
@section('adminContent')
    ...
    <div class='card'>
        ...
        <div class='card-body'>
            ...
            {{ Form::bsTextarea('content', ' ', $post->content, ['class' => 'tinymce form-control', 'name' => 'content']) }}<br>
            ...
            <div class="input-group mb-3">
                <input type="text" class="form-control" id="thumbnail" name="filepath" placeholder="{{ $post->thumbnail_path }}">
